...
* Tutors demonstrated an overall 7.4% learning gain from pretest to posttest across lessons.
...
## 📂 Repository Contents
* ```Human Open Response Scoring Rubrics```-- The codebooks for human annotators evaluating tutor open-resonse answers
...
##  📊 Data Access
Samples of data including lesson data and tutor transcriptions can be accessed in Datashop at https://anonymous.4open.science/r/Closing_the_Loop-7503/. Note: you must create or use a pre-existing Datashop account for access.
